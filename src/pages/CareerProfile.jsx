  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="container-app flex h-20 items-center justify-between">
        <Logo to="/" />
        <button onClick={handleSaveExit} className="text-sm font-semibold text-text-muted hover:text-dark-green">
          Save & Exit
        </button>
      </div>
      ...
      <div className="container-app flex justify-center pb-16 pt-2">
        <div className="w-full max-w-lg">
          ...
          {step === 2 && (
            <div>
              <p className="mb-3 text-sm font-medium text-text-dark">What's your main goal right now?</p>
